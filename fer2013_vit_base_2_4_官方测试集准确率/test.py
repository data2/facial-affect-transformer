...
class PrivateTestEvaluator:
    ...
    def evaluate(self, test_dir='./data/test', model_path='./best_model_80_target.pth'):
        """在测试集上评估模型"""
        print("=" * 70)
        print("🧪 开始在测试集上进行模型评估")
        print("=" * 70)
...
def run_full_evaluation(test_dir='./data/test', model_path='./best_model_80_target.pth'):
    """运行完整的评估流程"""
    print("=" * 70)
...
def quick_test(test_dir='./data/test', model_path='./best_model_80_target.pth'):
    """快速测试"""
    print("🚀 快速测试模式")
    print("=" * 70)
