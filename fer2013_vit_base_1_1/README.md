以下是完整的修复版代码，集成了针对disgust和fear类别的优化策略：
...
```python
# 基于第4个epoch结果调整权重
class_weights[1] *= 8.0  # disgust: 大幅增加权重
class_weights[2] *= 3.0  # fear: 增加权重
```
...
| Epoch | 预期准确率 | 关键目标 |
|-------|------------|----------|
| 5 | 68.5-69.5% | disgust > 15%, fear > 40% |
| 6 | 70-71% | 总体突破70%大关 |
| 7-8 | 72-74% | 稳定提升 |
| 9-10 | 75-78% | 接近80%目标 |
| 11-12 | 78-82% | 达到80%目标 |
...
这个版本会自动从第5个epoch开始训练，并应用所有针对disgust和fear类别的优化策略！ 🚀