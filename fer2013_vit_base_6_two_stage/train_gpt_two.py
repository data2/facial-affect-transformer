...
class Config3090:
    def __init__(self):
        ...
        self.best_model_path = './weights/best_model.pth'
        self.stage2_start_epoch = 11  # Stage-2 从第12个 epoch 开始
...
def train_main():
    ...
    if config.resume_from_best and os.path.exists(config.best_model_path):
        ...
        print(f"✅ Loaded Stage-1 best model (Epoch {ckpt['epoch']})")
    ...
    start_epoch = config.stage2_start_epoch
