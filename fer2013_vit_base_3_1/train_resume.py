# train_3090_optimized_resume.py - 支持续训的完整代码
import torch
...
class Config3090:
    ...
    def __init__(self):
        ...
        # 续训配置 - 新增
        self.resume_from = 'checkpoint_3090_epoch_025.pth'  # 从第25轮检查点继续
        self.start_epoch = 25  # 已完成的轮数
...
def train_3090(config):
    ...
    if config.dynamic_weight_adjust:
        weight_adjuster = DynamicWeightAdjuster(class_weights)
    else:
